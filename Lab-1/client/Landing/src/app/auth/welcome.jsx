...
const Welcome = () => {
  ...
  const loginUrl =
    "https://pooledtenant-serverlesssaas-297944203549.auth.us-east-1.amazoncognito.com/login?client_id=72sp659fh5a9mou9adst0320ra&response_type=code&scope=email+openid+profile&redirect_uri=http%3A%2F%2Flocalhost%3A5173";
