...
export default class MyAppStack extends sst.Stack {
  constructor(scope, id, props) {
    ...
    // Create Lambda Layer
    const serverlessSaaSLayer = new sst.LayerVersion(this, "ServerlessSaaSLayer", {
      srcPath: "layers",
    ...
    const authorizerRole = new sst.Role(this, "AuthorizerExecutionRole", {
      ...
      managedPolicies: [
        sst.ManagedPolicy.fromAwsManagedPolicyName("CloudWatchLambdaInsightsExecutionRolePolicy"),
        sst.ManagedPolicy.fromAwsManagedPolicyName("service-role/AWSLambdaBasicExecutionRole"),
    ...
    const sharedServicesAuthorizerFunction = new sst.Function(this, "SharedServicesAuthorizerFunction", {
    ...
    const createTenantAdminUserFunction = new sst.Function(this, "CreateTenantAdminUserFunction", {
    ...
    this.addOutputs({
      ...
      CreateTenantAdminUserFunctionArn: createTenantAdminUserFunction.functionArn,
